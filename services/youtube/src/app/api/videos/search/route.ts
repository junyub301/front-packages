...
const parseQueryParams = (params: URLSearchParams): GetSearchVideosListRequestParams => {
  return {
    q: params.get("q") ?? "",
...
const mappingResponse = (data: youtube_v3.Schema$SearchListResponse): GetSearchVideosListResponse => {
  const lists =
