...
const mappingResponse = (
  ...
  return {
    detail: {
      ...
      publishedAtDisplayText: formatKoreanTextCompareDatesFromNow(videoPublishedAt),
      viewCount: videoParsedViewCount,
      viewCountDisplayText: formatNumberToKoreanText(videoParsedViewCount, true),
      likeCount: videoLikeCount,
      likeCountDisplayText: formatNumberToKoreanText(videoLikeCount, true),
      dislikeCount: videoDislikeCount,
      dislikeCountDisplayText: formatNumberToKoreanText(videoDislikeCount, true),
      commentCount: videoCommentCount,
      commentCountDisplayText: formatNumberToKoreanText(videoCommentCount, true),
      channelInfo: {
        ...
        subscriberCountDisplayText: formatNumberToKoreanText(channelSubscriberCount, true),
