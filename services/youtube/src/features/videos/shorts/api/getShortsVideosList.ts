...
export type GetShortsVideosListRequestParams = Pick<youtube_v3.Params$Resource$Search$List, "pageToken">;
...
export const getShortsVideosList = async (params: GetShortsVideosListRequestParams) => {
